...
runs_results_dir = Path("data/output/pipeline/01_samples_test/runs_csv")
output_csv_path = Path("data/output/pipeline/01_samples_test/pipeline_test_runs_aggregated.csv")
