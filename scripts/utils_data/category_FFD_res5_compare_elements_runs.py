...
# === Configuration ===
input_dir = "data/output/category/01_samples_test/runs_csv"
output_file = "data/output/category/01_samples_test/category_test_success_matrix.csv"
reference_csv = "data/output/category/01_samples_test/Samples_Test_Category.csv"
score = "match"
