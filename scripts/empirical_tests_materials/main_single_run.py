...
def run_material_inference(config, parent_output_path):
    ...
    if var_1_include_geometry:
        ...
        base_input_dir = Path("data/input/materials_test/samples/exclude_geometry")
...
if __name__ == "__main__":
    ...
    parent_output_path = Path("data/output/material/02_combinations/t_f_t_f_t_f")

    # Specify config path
    config_path = Path("configs/material_tests/configs/t_f_t_f_t_f.yaml")
    ...
    preview_output_path = parent_output_path / "prompt_t_f_t_f_t_f.txt"
