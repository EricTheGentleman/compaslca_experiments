...
def run_single_match(bim_element, material_entries, output_path, mode, category, config):
    ...
    llm_response, token_usage = material_inference(bim_element, material_entries, mode, category, config)
    end_time = time.time()
