...
# 0  Settings
# ---------------------------------------------------------------------
DATA_DIR    = Path("data/output/pipeline/01_samples_test/runs_csv")
FILE_PATTERN = "*.csv"

COL_SAMPLE  = "Name"          # row identifier in every CSV
...
OUTPUT_DIR = Path(
    "data/output/pipeline/01_samples_test/bootstrap/pairwise_CI"
)
