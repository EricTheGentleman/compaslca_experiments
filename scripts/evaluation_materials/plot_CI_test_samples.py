...
# Load CSV
df = pd.read_csv("data/output/material/01_samples_test/bootstrap/pairwise_CI/F05_bootstrap_pairwise_vs_baseline.csv")
...
# Save plot
plt.tight_layout()
plt.savefig("data/output/material/01_samples_test/plots/materials_test_samples_deltaF05_vs_baseline.png", dpi=400)
plt.close()
...
# Save second plot
plt.tight_layout()
plt.savefig("data/output/material/01_samples_test/plots/materials_test_samples_pvalues.png", dpi=400)
plt.close()
...
# Save plot
plt.tight_layout()
plt.savefig("data/output/material/01_samples_test/plots/materials_test_samples_configurations.png", dpi=400)
plt.close()